...
useEffect(()=>{
  ...
  if(ref.current == 0){
    ...
    axios.get('getsecondtransactions').then((e) => e.data == "not authenticated" ?navigate("/login") :setSearcher(e.data) & setData(e.data.reverse()) )
...
// console.log(newData);
    ...
    const Delet=(e)=>{
      axios.get('/deletesecondtransaction/'+e).then((e) => console.log(e.data))
