...
useEffect(()=>{
  ...
  if(ref.current == 0){
    ...
    axios.get('https://amaccompany.onrender.com/getsecondtransactions').then((e) => e.data == "not authenticated" ?navigate("/login") :setSearcher(e.data) & setData(e.data.reverse()) )
